<div class="p-8">
	<div class="mb-6 text-center">
		<div class="w-20 h-20 mx-auto mb-4">
			<img src="/images/logos/logo.jpg" alt="Ayush Saksena" class="w-full h-full rounded-full object-cover" />
		</div>
	...
	<div class="mb-8 pb-6 border-b border-gray-100">
		<div class="grid grid-cols-2 xl:grid-cols-4 gap-2 xl:gap-4 justify-items-center">
			...
			<a 
				href="https://github.com/ayushsaksena30" 
				target="_blank" 
				rel="noopener noreferrer"
				class="flex items-center gap-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors"
			>
			...
			<a 
				href="https://linkedin.com/in/ayush-saksena" 
				target="_blank" 
				rel="noopener noreferrer"
				class="flex items-center gap-2 text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors"
			>
	...
	<div class="mb-8">
		<h3 class="text-md font-semibold text-gray-900 mb-4">Navigation</h3>
		<nav class="space-y-2">
			<a href="#about" class="block text-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors">About</a>
			<a href="#experience" class="block text-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors">Experience</a>
			<a href="#tech-stack" class="block text-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors">Tech Stack</a>
			<a href="#projects" class="block text-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors">Projects</a>
			<a href="#resume" class="block text-md text-gray-600 hover:text-gray-900 hover:bg-gray-50 p-2 rounded-md transition-colors">Resume</a>
